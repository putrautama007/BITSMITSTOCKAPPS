...
import com.raion.putrautama.bitsmitstockapps.sell.ListBarangAdapter

class ListBarang2Activity : AppCompatActivity() {
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                for (data in p0.children) {
                    if(data.child("kategori_id").value.toString().equals(idKategori)){
                        ...
                        val barangId = data.child("barang_id").value.toString()
                        ...
                        listItems.add(Barang(foto, harga.toInt(), jumlah.toInt(), nama, "", barangId))
                    }
                }
    ...
    fun intentToSell(barang: Barang){
        val intent =  Intent(this, RestockActivity::class.java)
        ...
        intent.putExtra("kategoriId", barang.kategori_id)
